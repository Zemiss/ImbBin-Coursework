...
```powershell
python main\train.py --train_data data\ml_train.csv --model_path main\models\model.joblib
```

## 测试

```powershell
python main\test.py --test_data data\ml_train.csv --model_path main\models\model.joblib
```
